...
'''
    ...
    def _add_wildcard_to_new_mappings(self, wildcard: str, category: str,
        ...
        Args:
            ...
            source_file: Source file name (e.g., 'private_mappings.toml' or 'public_mappings.toml')
        ...
        try:
            ...
            # Determine scope from source_file if provided, otherwise default to private
            if source_file:
                scope = "public" if "public" in source_file else "private"
            else:
                scope = "private"
