...
class TestMLCategorizer:
    ...
    def test_ml_categorizer_confidence_threshold(self):
        ...
        result = categorizer.predict(
            {"merchant_name": "UNKNOWN STORE", "amount": 25.00},
            confidence_threshold=0.95
        )
...
class TestMLCategorizerIntegration:
    ...
    def test_ml_categorizer_performance_requirement(self):
        ...
        transactions = []
        merchants = ["STARBUCKS", "SHELL", "WALMART", "AMAZON", "WHOLE FOODS",
                    "CVS", "TARGET", "BEST BUY", "RESTAURANT A", "RESTAURANT B"]
        categories = [
        ...
        for i in range(100):
            for merchant, (cat, subcat) in zip(merchants, categories):
                transactions.append({
...
class TestMLCategoriserEdgeCases:
    ...
    def test_ml_categorizer_special_characters(self):
        ...
        result = categorizer.predict({
            "merchant_name": "STARBUCKS & CO #123",
            "amount": 5.50
        })
