...
class TestEnrichTransactionExtended:
    ...
    def test_enrich_fuzzy_threshold_low(self):
        ...
        transaction = {
            "description": "UNKNOWN_MERCHANT_XYZ",
            "amount": 5.00,
            "date": "2024-01-15"
        }
    ...
    def test_plaid_matching_with_keywords(self):
        ...
        plaid_categories = {
            ...
            "FOOD_AND_DRINK.FOOD_AND_DRINK_COFFEE": {
                "keywords": ["coffee", "cafe", "starbucks"]
            }
        }
        
        result = apply_plaid_keyword_matching("STARBUCKS COFFEE SHOP", "starbucks", plaid_categories)
